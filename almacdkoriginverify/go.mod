module github.com/alma-cdk/origin-verify-go/almacdkoriginverify/v2
...
require (
	...
	github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v54 v54.16.0 // indirect
)
